...
import os
class Parameters:
    def __init__(self,input_dim,hidden_dim,batch_size,epochs,learning_rate,rnn,level,mode,split):
      ...
      self.save_path = f"models/models{split}/{rnn}_{level}_{hidden_dim}_{epochs}_{learning_rate}_model.pt"
