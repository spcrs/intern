...
def test_and_save(params,split):
    
    input_coeffs_file = f"dwt_data/test_input{split}.csv"
    output_coeffs_file = f"dwt_data/test_output{split}.csv"
    save_output = f"result/predicted_coeffs{split}.csv"
