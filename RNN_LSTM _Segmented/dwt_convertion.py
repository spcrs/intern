...
def convert_dwt_and_save(params,tort,split):
    input_folder_path = f"data/{tort}{split}/"
    input_path = f"dwt_data/{tort}_input{split}.csv"
    output_path = f"dwt_data/{tort}_output{split}.csv"
