...
import os
class Parameters:
    def __init__(self,input_dim,hidden_dim,batch_size,epochs,learning_rate,rnn,level,mode,folds):
    ...
    def for_folds(self,fold):
      self.save_path = f"models/{self.rnn}_{self.level}_{self.hidden_dim}_{self.epochs}_{self.learning_rate}_model_fold{fold}.pt"
