...
def test_and_save(params,fold,split):
    
    input_coeffs_file = f"folds/folds{split}/test_input_fold{fold}.csv"
    output_coeffs_file = f"folds/folds{split}/test_output_fold{fold}.csv"
    save_output = f"result/result{split}/predicted_coeffs_fold{fold}.csv"
