...
def convert_dwt_and_save(params,split):
    input_folder_path = f"data/train{split}/"
    input_path = f"dwt_data/train_input{split}.csv"
    output_path = f"dwt_data/train_output{split}.csv"
