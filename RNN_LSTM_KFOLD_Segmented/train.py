...
def build_train_and_save_model(params,fold,split):
    ...
    input_coeffs_file = f"folds/folds{split}/train_input_fold{fold}.csv"
    output_coeffs_file = f"folds/folds{split}/train_output_fold{fold}.csv"
